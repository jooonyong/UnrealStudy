...
AMyABCharacterPlayer::AMyABCharacterPlayer()
{
	...
	static ConstructorHelpers::FObjectFinder<UInputAction> InputActionChangeActionRef(TEXT("/Script/EnhancedInput.InputAction'/Game/ArenaBattle/Input/Actions/IA_ChangeControl.IA_ChangeControl'"));
	if (nullptr != InputActionChangeActionRef.Object)
	{
		ChangeControlAction = InputActionChangeActionRef.Object;
	}
...
void AMyABCharacterPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	EnhancedInputComponent->BindAction(QuarterMoveAction, ETriggerEvent::Triggered, this, &AMyABCharacterPlayer::QuarterMove);
...
void AMyABCharacterPlayer::QuarterMove(const FInputActionValue& Value)
{
	FVector2D MovementVector = Value.Get<FVector2D>();

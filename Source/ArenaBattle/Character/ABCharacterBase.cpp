...
AABCharacterBase::AABCharacterBase()
{
    ...
    static ConstructorHelpers::FObjectFinder<UAnimMontage> ComboActionMontageRef(TEXT("/Script/Engine.AnimMontage'/Game/ArenaBattle/Animations/AM_ComboAttack.AM_ComboAttack'"));
    ...
    static ConstructorHelpers::FObjectFinder<UAnimMontage> DeadMontageRef(TEXT("/Script/Engine.AnimMontage'/Game/ArenaBattle/Animations/AM_Dead.AM_Dead'"));

...
AABStageGimmick::AABStageGimmick()
{
    ...
    static ConstructorHelpers::FObjectFinder<class UStaticMesh> GateMeshRef(TEXT("/Script/Engine.StaticMesh'/Game/ArenaBattle/Environment/Props/SM_GATE.SM_GATE'"));
...
void AABStageGimmick::CloseAllGates()
{
    for (auto Gate : Gates)
    {
        (Gate.Value)->SetRelativeRotation(FRotator(FRotator::ZeroRotator));
    }
}
